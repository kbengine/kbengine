...
PySequenceMethods ScriptVector2::seqMethods =
{
	...
	ScriptVector2::seq_slice,		/* sq_slice */
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyGetVectorLength(PyObject *self, void *closure)
{ 
	ScriptVector2* sv = static_cast<ScriptVector2*>(self);
	Vector2& v = sv->getVector();
	return PyFloat_FromDouble(KBEVec2Length(&v)); 
}

//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyGetVectorLengthSquared(PyObject *self, void *closure)
{ 
	ScriptVector2* sv = static_cast<ScriptVector2*>(self);
	Vector2& v = sv->getVector();
	return PyFloat_FromDouble(KBEVec2LengthSq(&v));
}

//-------------------------------------------------------------------------------------
int ScriptVector2::seq_length(PyObject* self)
{
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::seq_item(PyObject* self, int index)
{
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::seq_slice(PyObject* self, int startIndex, int endIndex)
{
	if(startIndex < 0)
		startIndex = 0;
...
//-------------------------------------------------------------------------------------
int ScriptVector2::seq_ass_item(PyObject* self, int index, PyObject* value)
{
	ScriptVector2* sv = static_cast<ScriptVector2*>(self);
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyDistTo(PyObject* self, PyObject* args)
{
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyDistSqrTo(PyObject* self, PyObject* args)
{
	if (PyTuple_Size(args) != 1)
	{
		PyErr_SetString(PyExc_TypeError, "args > 1 is error!\n");
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyCross2D(PyObject* self, PyObject* args)
{
	ScriptVector2* v = new ScriptVector2(0,0);
	ScriptVector2* sv = static_cast<ScriptVector2*>(self);
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyScale(PyObject* self, PyObject* args)
{
	if(PyTuple_Size(args) == 1)
	{
		ScriptVector2* sv = static_cast<ScriptVector2*>(self);
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyDot(PyObject* self, PyObject* args)
{
	ScriptVector2* v = new ScriptVector2(0,0);
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyNormalise(PyObject* self, PyObject* args)
{
	if (PyTuple_Size(args) != 0)
	{
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyTuple(PyObject* self, PyObject* args)
{
	if (PyTuple_Size(args) != 0)
	{
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pyList(PyObject* self, PyObject* args)
{
	if (PyTuple_Size(args) != 0)
	{
		PyErr_SetString(PyExc_TypeError, "Vector.tuple takes no arguments");
...
//-------------------------------------------------------------------------------------
PyObject* ScriptVector2::pySet(PyObject* self, PyObject* args)
{
	ScriptVector2* sv = static_cast<ScriptVector2*>(self);
	bool good = false;
	Vector2 v;
