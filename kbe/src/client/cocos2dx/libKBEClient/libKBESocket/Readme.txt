...
2. BasicSocket Library:
   i create KBundle ,KMemoryStream, KNetworkInterface, KMessage . theese classes works on KBE Level. 
   base_sock is a wrapper of socket. 
   

current status: it can connect to server, can send Login_importClientMessages packet, got response and do parse. to do more debug,ensure it works correctly!
